...
#define TRUE 1
#define FALSE 0
#define T1BOTTOM 65536-250 /*10ms*/

// REPOSITORY PARAMETERS
#define END_OF_THE_LINE 25
#define ALPHABET 25
#define KATAKANA 25
#define INTERFACE 0
#define TRABALHAR 1
...
uint8_t repository1[ALPHABET][END_OF_THE_LINE]={ // TAMANHO, POSX, POSY, MODO
    ...
    {9  , 50 ,100,WALK, 50 ,50  ,WRITE, 65 ,50  ,WRITE},                                                                            //l
    ...
    {21 , 50 ,50 ,WALK, 50 ,100 ,WRITE, 65 ,100 ,WRITE, 65, 50, WRITE, 50, 50,WRITE, 60, 60, WALK, 70,40,WRITE },                   //q
    ...
    {12 , 50 ,100,WALK, 50 ,50  ,WRITE, 65 ,50  ,WRITE, 65, 100,WRITE},                                                             //u
    ...
    while(1){
        switch(state){
            ...
            case TRABALHAR:{
                ...
                Point TargetPos = { (float) repository1[word][WORD_POINT_X] /10 , (float) repository1[word][WORD_POINT_Y] /10};
                InverseKinematics(Origin, TargetPos, &TargetPos.theta1, &TargetPos.theta2);
